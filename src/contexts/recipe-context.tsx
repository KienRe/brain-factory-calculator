...
interface RecipeContextType {
  recipes: Recipes;
  updateRecipe: (resourceId: string, recipeId: string, updatedRecipe: Recipe) => void;
...
export function RecipeProvider({ children }: { children: React.ReactNode }) {
  ...
  const updateRecipe = (resourceId: string, recipeId: string, updatedRecipe: Recipe) => {
    setRecipes(prev => ({
      ...prev,
  ...
  return (
    <RecipeContext.Provider value={{ recipes, updateRecipe, deleteRecipe, addRecipe }}>
      {children}
